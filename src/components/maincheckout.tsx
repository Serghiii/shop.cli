								...
								{Cart.length > 0 && (
									<div className='checkout-grid-container'>
										{Cart.map((item: ODetails) => (
											<>
												<div key={item.id} className='checkout-grid-item checkout-grid-item-code'>
													{item.code}
												</div>
												<div key={item.id} className='checkout-grid-item checkout-grid-item-name'>
													{tt(item.name, lang)}
												</div>
												<div key={item.id} className='checkout-grid-item checkout-grid-item-amount'>
													{item.amount}
												</div>
												<div key={item.id} className='checkout-grid-item checkout-grid-item-sum'>
